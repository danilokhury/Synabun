...
import {
  gscNavigateSchema, gscNavigateDescription, handleGscNavigate,
  gscPropertySchema, gscPropertyDescription, handleGscProperty,
} from './gsc/navigate.js';

import {
  gscInspectUrlSchema, gscInspectUrlDescription, handleGscInspectUrl,
  gscInspectTestLiveSchema, gscInspectTestLiveDescription, handleGscInspectTestLive,
  gscInspectRequestIndexingSchema, gscInspectRequestIndexingDescription, handleGscInspectRequestIndexing,
  gscInspectViewCrawledSchema, gscInspectViewCrawledDescription, handleGscInspectViewCrawled,
} from './gsc/inspect.js';

import {
  gscPerformanceQuerySchema, gscPerformanceQueryDescription, handleGscPerformanceQuery,
  gscPerformanceExportSchema, gscPerformanceExportDescription, handleGscPerformanceExport,
  gscPerformanceChartScreenshotSchema, gscPerformanceChartScreenshotDescription, handleGscPerformanceChartScreenshot,
} from './gsc/performance.js';

import {
  gscPagesReportSchema, gscPagesReportDescription, handleGscPagesReport,
  gscPagesValidateFixSchema, gscPagesValidateFixDescription, handleGscPagesValidateFix,
  gscVideosReportSchema, gscVideosReportDescription, handleGscVideosReport,
  gscSitemapSchema, gscSitemapDescription, handleGscSitemap,
  gscRemovalsSchema, gscRemovalsDescription, handleGscRemovals,
  gscRemovalsCancelSchema, gscRemovalsCancelDescription, handleGscRemovalsCancel,
} from './gsc/indexing.js';

import {
  gscCwvReportSchema, gscCwvReportDescription, handleGscCwvReport,
  gscHttpsReportSchema, gscHttpsReportDescription, handleGscHttpsReport,
  gscSecurityIssuesSchema, gscSecurityIssuesDescription, handleGscSecurityIssues,
  gscManualActionsSchema, gscManualActionsDescription, handleGscManualActions,
  gscEnhancementsSchema, gscEnhancementsDescription, handleGscEnhancements,
  gscLinksReportSchema, gscLinksReportDescription, handleGscLinksReport,
  gscLinksExportSchema, gscLinksExportDescription, handleGscLinksExport,
} from './gsc/experience.js';

import {
  gscSettingsSchema, gscSettingsDescription, handleGscSettings,
  gscCrawlStatsSchema, gscCrawlStatsDescription, handleGscCrawlStats,
  gscUsersSchema, gscUsersDescription, handleGscUsers,
  gscAssociationsSchema, gscAssociationsDescription, handleGscAssociations,
  gscDisavowSchema, gscDisavowDescription, handleGscDisavow,
  gscShoppingSchema, gscShoppingDescription, handleGscShopping,
  gscExtractTableSchema, gscExtractTableDescription, handleGscExtractTable,
  gscScreenshotSchema, gscScreenshotDescription, handleGscScreenshot,
} from './gsc/settings.js';

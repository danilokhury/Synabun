...
export const browserNavigateDescription =
  'Navigate the browser to a URL. If no browser session exists, one is created automatically. Pass returnSnapshot to fold a browser_snapshot into the same call.';

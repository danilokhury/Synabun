...
export function buildMemoriesSchema() {
    return {
        action: z
            .enum(['recent', 'stats', 'by-category', 'by-project'])
            .describe('recent=latest memories, stats=counts and health, by-category=filter by type, by-project=filter by project.'),
        category: z
            .string()
            .optional()
...
export const memoriesDescription = 'Browse recent memories or get statistics. Use this to see what you remember about a project, review recent learnings, or check memory health.';

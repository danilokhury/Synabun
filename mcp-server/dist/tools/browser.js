import { browserNavigateSchema, browserNavigateDescription, handleBrowserNavigate, browserGoBackSchema, browserGoBackDescription, handleBrowserGoBack, browserGoForwardSchema, browserGoForwardDescription, handleBrowserGoForward, browserReloadSchema, browserReloadDescription, handleBrowserReload, } from './browser-navigate.js';
import { browserClickSchema, browserClickDescription, handleBrowserClick, browserFillSchema, browserFillDescription, handleBrowserFill, browserTypeSchema, browserTypeDescription, handleBrowserType, browserHoverSchema, browserHoverDescription, handleBrowserHover, browserSelectSchema, browserSelectDescription, handleBrowserSelect, browserPressSchema, browserPressDescription, handleBrowserPress, browserScrollSchema, browserScrollDescription, handleBrowserScroll, browserUploadSchema, browserUploadDescription, handleBrowserUpload, } from './browser-interact.js';
import { browserSnapshotSchema, browserSnapshotDescription, handleBrowserSnapshot, browserContentSchema, browserContentDescription, handleBrowserContent, browserScreenshotSchema, browserScreenshotDescription, handleBrowserScreenshot, browserExtractTweetsSchema, browserExtractTweetsDescription, handleBrowserExtractTweets, browserExtractFbPostsSchema, browserExtractFbPostsDescription, handleBrowserExtractFbPosts, browserExtractTiktokVideosSchema, browserExtractTiktokVideosDescription, handleBrowserExtractTiktokVideos, browserExtractTiktokSearchSchema, browserExtractTiktokSearchDescription, handleBrowserExtractTiktokSearch, browserExtractTiktokStudioSchema, browserExtractTiktokStudioDescription, handleBrowserExtractTiktokStudio, browserExtractTiktokProfileSchema, browserExtractTiktokProfileDescription, handleBrowserExtractTiktokProfile, browserExtractWaChatsSchema, browserExtractWaChatsDescription, handleBrowserExtractWaChats, browserExtractWaMessagesSchema, browserExtractWaMessagesDescription, handleBrowserExtractWaMessages, browserExtractIgFeedSchema, browserExtractIgFeedDescription, handleBrowserExtractIgFeed, browserExtractIgProfileSchema, browserExtractIgProfileDescription, handleBrowserExtractIgProfile, browserExtractIgPostSchema, browserExtractIgPostDescription, handleBrowserExtractIgPost, browserExtractIgReelsSchema, browserExtractIgReelsDescription, handleBrowserExtractIgReels, browserExtractIgSearchSchema, browserExtractIgSearchDescription, handleBrowserExtractIgSearch, browserExtractLiFeedSchema, browserExtractLiFeedDescription, handleBrowserExtractLiFeed, browserExtractLiProfileSchema, browserExtractLiProfileDescription, handleBrowserExtractLiProfile, browserExtractLiPostSchema, browserExtractLiPostDescription, handleBrowserExtractLiPost, browserExtractLiNotificationsSchema, browserExtractLiNotificationsDescription, handleBrowserExtractLiNotifications, browserExtractLiMessagesSchema, browserExtractLiMessagesDescription, handleBrowserExtractLiMessages, browserExtractLiSearchPeopleSchema, browserExtractLiSearchPeopleDescription, handleBrowserExtractLiSearchPeople, browserExtractLiNetworkSchema, browserExtractLiNetworkDescription, handleBrowserExtractLiNetwork, browserExtractLiJobsSchema, browserExtractLiJobsDescription, handleBrowserExtractLiJobs, } from './browser-observe.js';
import { browserEvaluateSchema, browserEvaluateDescription, handleBrowserEvaluate, browserWaitSchema, browserWaitDescription, handleBrowserWait, browserSessionSchema, browserSessionDescription, handleBrowserSession, } from './browser-advanced.js';
import { browserCheatsheetSchema, browserCheatsheetDescription, handleBrowserCheatsheet, } from './browser-cheatsheet.js';
/**
 * Register 18 core browser tools (navigation, interaction, observation, advanced).
 */
export function registerBrowserCoreTools(server) {
    return [
        // Navigation
...
/** Register Twitter/X extractor (1 tool). */
export function registerBrowserTwitterTools(server) {
    return [
        server.tool('browser_extract_tweets', browserExtractTweetsDescription, browserExtractTweetsSchema, handleBrowserExtractTweets),
    ];
}
/** Register Facebook extractor (1 tool). */
export function registerBrowserFacebookTools(server) {
    return [
...
export function registerBrowserTiktokTools(server) {
    return [
...
export function registerBrowserWhatsappTools(server) {
    return [
...
export function registerBrowserInstagramTools(server) {
    return [
...
export function registerBrowserLinkedinTools(server) {
    return [

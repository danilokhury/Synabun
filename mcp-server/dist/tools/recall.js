...
function applyTimeDecay(rawScore, createdAt, importance, accessCount) {
    if (importance >= 8)
        return rawScore;
...
export async function handleRecall(args) {
    ...
    const scored = results
        ...
        let adjustedScore = applyTimeDecay(r.score, payload.created_at, payload.importance, payload.access_count);

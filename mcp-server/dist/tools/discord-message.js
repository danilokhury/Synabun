...
export const discordMessageDescription = 'Discord message operations. Actions: send, edit, delete, pin, unpin, react, bulk_delete, list.';
// ── Helpers ────────────────────────────────────────────────────
async function resolveChannelId(channel, guildId) {

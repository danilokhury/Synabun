...
export function injectStyles() {
  ...
  style.textContent = `
    ...
    /* Legacy dropdowns put the open state on the menu rather than its wrapper. */
    .ocp-panel:has(.ocp-dd-menu.open) {
      z-index: 99999;
    }
    ...
    .ocp-question-skip:hover:not(:disabled) {
      background: rgba(232,224,220,0.06);
      border-color: rgba(232,224,220,0.22);
      color: rgba(232,224,220,0.85);
    }
    .ocp-question-skip:disabled {
      opacity: 0.35;
      cursor: not-allowed;
    }

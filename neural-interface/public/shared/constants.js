...
export const KEYS = {
  ...
  NOTIF_BANNER:          'neural-notif-banner',
  NOTIF_BANNER_FOCUSED:  'neural-notif-banner-focused',
  NOTIF_ACTION_ONLY:     'neural-notif-action-only',
  NOTIF_SOURCE_CLI:      'neural-notif-source-cli',
  NOTIF_SOURCE_PANEL:    'neural-notif-source-panel',
  NOTIF_TRIGGER_DONE:    'neural-notif-trigger-done',
...
export const KEYBIND_META = {
  ...
  'launch-opencode':     { label: 'OpenCode',              group: 'Launch App', icon: 'opencode' },

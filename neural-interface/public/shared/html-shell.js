      ...
      <div class="menubar-item" data-menu="apps">
        ...
        <div class="menubar-dropdown glass">
          ...
          <div class="menu-item" id="menu-terminal-opencode">
            <span class="menu-check"></span>
            <span class="menu-text"><span class="menu-icon"><svg viewBox="0 0 240 300" fill="currentColor"><path fill-rule="evenodd" d="M0 0h240v300H0V0zm60 60v180h120V60H60z"/><rect x="60" y="120" width="120" height="120" opacity=".45"/></svg></span> ${t('menu.apps.openCode')}</span>
...
<div id="topright-controls">
  ...
  <button id="topright-opencode-panel-btn" class="topright-icon-btn" data-tooltip="OpenCode side panel">
    <svg viewBox="0 0 240 300" fill="currentColor" width="16" height="16"><path fill-rule="evenodd" d="M0 0h240v300H0V0zm30 30v240h180V30H30z"/><rect x="30" y="150" width="180" height="120" opacity=".45"/></svg>
  </button>

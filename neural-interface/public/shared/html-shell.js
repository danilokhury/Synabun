...
<div id="title-bar">
  <div class="bar-left">
    <img src="synabun.png?v=2" alt="SynaBun" id="titlebar-logo" style="height:24px;width:auto;cursor:pointer;" data-tooltip="${t('tooltip.toggleExplorer')}">
      ...
      <div class="menubar-item" data-menu="apps">
        ...
        <div class="menubar-dropdown glass">
          ...
          <div class="menu-item" id="menu-terminal-codex">
            <span class="menu-check"></span>
            <span class="menu-text"><span class="menu-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.205 8.658v-2.26c0-.19.072-.333.238-.428l4.543-2.616c.619-.357 1.356-.523 2.117-.523 2.854 0 4.662 2.212 4.662 4.566 0 .167 0 .357-.024.547l-4.71-2.759a.797.797 0 00-.856 0l-5.97 3.473zm10.609 8.8V12.06c0-.333-.143-.57-.429-.737l-5.97-3.473 1.95-1.118a.433.433 0 01.476 0l4.543 2.617c1.309.76 2.189 2.378 2.189 3.948 0 1.808-1.07 3.473-2.76 4.163zM7.802 12.703l-1.95-1.142c-.167-.095-.239-.238-.239-.428V5.899c0-2.545 1.95-4.472 4.591-4.472 1 0 1.927.333 2.712.928L8.23 5.067c-.285.166-.428.404-.428.737v6.898zM12 15.128l-2.795-1.57v-3.33L12 8.658l2.795 1.57v3.33L12 15.128zm1.796 7.23c-1 0-1.927-.332-2.712-.927l4.686-2.712c.285-.166.428-.404.428-.737v-6.898l1.974 1.142c.167.095.238.238.238.428v5.233c0 2.545-1.974 4.472-4.614 4.472zm-5.637-5.303l-4.544-2.617c-1.308-.761-2.188-2.378-2.188-3.948A4.482 4.482 0 014.21 6.327v5.423c0 .333.143.571.428.738l5.947 3.449-1.95 1.118a.432.432 0 01-.476 0zm-.262 3.9c-2.688 0-4.662-2.021-4.662-4.519 0-.19.024-.38.047-.57l4.686 2.71c.286.167.571.167.856 0l5.97-3.448v2.26c0 .19-.07.333-.237.428l-4.543 2.616c-.619.357-1.356.523-2.117.523zm5.899 2.83a5.947 5.947 0 005.827-4.756C22.287 18.339 24 15.84 24 13.296c0-1.665-.713-3.282-1.998-4.448.119-.5.19-.999.19-1.498 0-3.401-2.759-5.947-5.946-5.947-.642 0-1.26.095-1.88.31A5.962 5.962 0 0010.205 0a5.947 5.947 0 00-5.827 4.757C1.713 5.447 0 7.945 0 10.49c0 1.666.713 3.283 1.998 4.448-.119.5-.19 1-.19 1.499 0 3.401 2.759 5.946 5.946 5.946.642 0 1.26-.095 1.88-.309a5.96 5.96 0 004.162 1.713z"/></svg></span> ${t('menu.apps.codexCli')} <span class="count-badge count-badge--green menu-update-badge" id="codex-menu-update-badge"></span></span>
            <span class="menu-shortcut" data-keybind-for="launch-codex"></span>
          </div>
          <div class="menu-item" id="menu-terminal-gemini">
            <span class="menu-check"></span>
            <span class="menu-text"><span class="menu-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M20.616 10.835a14.147 14.147 0 01-4.45-3.001 14.111 14.111 0 01-3.678-6.452.503.503 0 00-.975 0 14.134 14.134 0 01-3.679 6.452 14.155 14.155 0 01-4.45 3.001c-.65.28-1.318.505-2.002.678a.502.502 0 000 .975c.684.172 1.35.397 2.002.677a14.147 14.147 0 014.45 3.001 14.112 14.112 0 013.679 6.453.502.502 0 00.975 0c.172-.685.397-1.351.677-2.003a14.145 14.145 0 013.001-4.45 14.113 14.113 0 016.453-3.678.503.503 0 000-.975 13.245 13.245 0 01-2.003-.678z"/></svg></span> ${t('menu.apps.geminiCli')} <span class="count-badge count-badge--green menu-update-badge" id="gemini-menu-update-badge"></span></span>
            <span class="menu-shortcut" data-keybind-for="launch-gemini"></span>
          </div>
          <div class="menu-item" id="menu-terminal-opencode">
            <span class="menu-check"></span>
            <span class="menu-text"><span class="menu-icon"><svg viewBox="0 0 240 300" fill="currentColor"><path fill-rule="evenodd" d="M0 0h240v300H0V0zm60 60v180h120V60H60z"/><rect x="60" y="120" width="120" height="120" opacity=".45"/></svg></span> ${t('menu.apps.openCode')} <span class="count-badge count-badge--green menu-update-badge" id="opencode-menu-update-badge"></span></span>
            <span class="menu-shortcut" data-keybind-for="launch-opencode"></span>
          </div>
          <div class="menu-sep"></div>
          <div class="menu-item" id="menu-check-cli-updates">
            <span class="menu-check"></span>
            <span class="menu-text"><span class="menu-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg></span> Check for updates</span>
          </div>
          <div class="menu-sep"></div>
          ...
          <div class="menu-item" id="menu-stop-server">
            <span class="menu-check"></span>
            <span class="menu-text"><span class="menu-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="5" width="14" height="14" rx="2"/></svg></span> Stop Server</span>
          </div>
        </div>
      </div>
  ...
  <div class="bar-right">
    <div class="bar-group">
      <button id="titlebar-cost-btn" class="bar-icon bar-cost-btn" data-tooltip="Cost Tracker" hidden><span class="bar-cost-label">$0</span></button>
      <button id="titlebar-sessions-btn" class="bar-icon" data-tooltip="Notifications"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 6 2.5 8 2.5 8H3.5S6 14 6 8z"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg><span class="count-badge" id="titlebar-notifications-count" hidden></span></button>
      <button id="titlebar-gallery-btn" class="bar-icon" data-tooltip="Image Gallery"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg></button>
    </div>
    <span class="bar-divider"></span>
    <div class="bar-group">
      <button id="titlebar-tutorial-btn" class="bar-icon" data-tooltip="Toggle Tutorial"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M10.125 8.875C10.125 7.83947 10.9645 7 12 7C13.0355 7 13.875 7.83947 13.875 8.875C13.875 9.56245 13.505 10.1635 12.9534 10.4899C12.478 10.7711 12 11.1977 12 11.75V13"/><circle cx="12" cy="16" r="1" fill="currentColor" stroke="none"/><path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8"/></svg></button>
    </div>
    <span class="bar-divider"></span>
    <div class="bar-group">
    ...
    <div class="bar-group bar-group--clock">
      <div id="schedule-queue-overlay">
        <button id="titlebar-queue-btn" class="bar-icon" data-tooltip="Schedule Queue"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h10M4 18h14"/><circle cx="19" cy="12" r="3"/></svg><span class="count-badge" id="titlebar-queue-count" hidden></span></button>
        <div id="schedule-queue-dropdown" style="display:none;">
          <div id="sq-main"></div>
        </div>
      </div>
...
<div id="topright-controls">
  ...
  <button id="topright-update-btn" class="topright-icon-btn" style="display:none" data-tooltip="Update available">
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
  ...
  <button id="topright-codex-panel-btn" class="topright-icon-btn" data-tooltip="Codex side panel">
    ...
    <span class="count-badge count-badge--green" id="codex-update-badge"></span>
  </button>
  ...
  <div id="wb-root">
    <div id="wb-toolbar" class="glass">
      ...
      <button class="wb-tool" data-tool="arrow" data-tooltip="Arrow · hold Ctrl = multi">
        <svg viewBox="0 0 24 24" fill="none"><path d="M5 17L17 5" stroke-width="2" stroke-linecap="round"/><path d="M17 5L10 5M17 5L17 12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
      </button>
      <button class="wb-tool" data-tool="shape" data-tooltip="Shape · hold Ctrl = multi">
        <svg viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="3"/></svg>
      </button>
      <div id="wb-shape-picker" class="glass" style="display:none;"></div>
      ...
      <button class="wb-tool" data-tool="section" data-tooltip="Wireframe section · hold Ctrl = multi">
        <svg viewBox="0 0 24 24" fill="none"><rect x="2" y="3" width="20" height="4" rx="1"/><rect x="2" y="9" width="6" height="12" rx="1"/><rect x="10" y="9" width="12" height="7" rx="1"/><rect x="10" y="18" width="12" height="3" rx="1"/></svg>
      </button>

...
1. **Base Score**: Cosine similarity from vector search
...
2. Build filter (clauses for category/project/tags/importance)
3. Search SQLite with `limit * 2` (over-fetch for re-ranking headroom)

...
> Describe your vision — what happens in the scene, what's the mood, what's the purpose?

After they respond, mentally categorize into one of:
...
### Build the prompt
Using the user's description from Phase 1, the motion control from Phase 3, and all style context, craft the perfect prompt. Show it to the user and ask for approval before proceeding.
